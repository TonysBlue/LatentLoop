...
def test_production_deployment_does_not_accept_missing_physical_endpoint(tmp_path) -> None:
    config = {
    ...
    with pytest.raises(ValueError, match="spice_audio_playback_command"):
